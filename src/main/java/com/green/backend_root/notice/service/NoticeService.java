...
public class NoticeService {
  ...
  public void updateNotice(NoticeDTO noticeDTO) {
    ...
    List<String> noticeAttachedImgNameList = noticeMapper.getNoticeImgListForUpdate(noticeDTO.getImgNumArr());

    if(noticeDTO.getImgNumArr() != null && noticeDTO.getImgNumArr().length != 0){
      // 공지 이미지 삭제
      noticeMapper.deleteNoticeImgs(noticeDTO.getImgNumArr());
